...
export type DAUChartProps = {
  width: number;
  height: number;
};

const DAUChart = withTooltip<DAUChartProps, TooltipData>(
  ({
    width,
    height,
    tooltipOpen,
    ...
    showTooltip,
    hideTooltip,
  }: DAUChartProps & WithTooltipProvidedProps<TooltipData>) => {
  ...
  return (
    <Card className="h-full flex flex-col">
      <CardHeader className="pb-0">
        ...
        <CardDescription>
          Number of active users over the past 7 days.
        </CardDescription>
      </CardHeader>
      <CardContent
      ...
      >
        ...
        >
          ...
          {!isLoading &&
            ...
            dimensions.height > 0 && (
              <OverlayWrapper>
                <DAUChart width={dimensions.width} height={dimensions.height} />
              </OverlayWrapper>
            )}
        </div>
      </CardContent>
